...
checks = {
    ...
    "node dependency preflight": (node_preflight, (
        ...
        "BUILD_REVIEW_MODE=SINGLE_REVIEW_BATCH", "BUILD_REVIEW_COMMAND=pnpm ignored-builds",
        "BUILD_REVIEW_WORKDIR", "INSTALL_TIMEOUT_SECONDS = 600", "STATUS=pass", "STATUS=blocked",
    )),
