...
class ChangeSummaryTests(unittest.TestCase):
    ...
    def test_scopes_tracked_and_untracked_changes(self) -> None:
        ...
        self.assertIn(f"HEAD_SHA={git(self.repo, 'rev-parse', 'HEAD')}", proc.stdout)
        ...
        self.assertEqual(state["workspace"], str(self.repo.resolve()))
        self.assertEqual(state["branch"], "main")
        self.assertEqual(state["head_sha"], git(self.repo, "rev-parse", "HEAD"))
